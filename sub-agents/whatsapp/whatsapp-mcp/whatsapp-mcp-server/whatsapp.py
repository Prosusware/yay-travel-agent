...
def send_read_receipt(message_id: str, chat_jid: str, sender_jid: Optional[str] = None) -> Tuple[bool, str]:
    """Send a read receipt for a specific message.
    
    Args:
        message_id: The ID of the message to mark as read
        chat_jid: The JID of the chat containing the message
        sender_jid: The JID of the sender (required for group chats, optional for direct chats)
    ...
    try:
        ...
        print(f"DEBUG: Sending read receipt for message_id='{message_id}', chat_jid='{chat_jid}', sender_jid='{sender_jid}'")
        
        url = f"{WHATSAPP_API_BASE_URL}/read_receipt"
        payload = {
            "message_id": message_id,
            "chat_jid": chat_jid
        }
        
        # Add sender JID if provided (needed for group chats)
        if sender_jid:
        ...
        print(f"DEBUG: Received response status_code={response.status_code}")
